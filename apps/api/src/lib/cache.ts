// ══════════════════════════════════════════
//  Admin cache (blacklist, disabled endpoints, apikeys)
//  Di-refresh tiap 30 detik dari Firestore
// ══════════════════════════════════════════
...
export async function reloadCache() {
  try {
    ...
    console.log(`[cache] refreshed — ${cache.blacklist.size} blocked, ${cache.disabledEndpoints.size} disabled, ${cache.apikeys.size} keys`)
  } catch (e: any) {
