  ...
  return (
    <main style={{ minHeight: '100vh', padding: '2.5rem 1.25rem 4rem', maxWidth: 880, margin: '0 auto' }}>
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: '1.7rem', fontWeight: 700, marginBottom: '.3rem' }}>API Keys</h1>
        <p style={{ fontSize: '.72rem', color: 'var(--muted)' }}>Kelola API key buat akses Lumina API.</p>
      </div>
