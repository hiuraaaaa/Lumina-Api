...
export default function DashboardPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', padding: '6.5rem 1.25rem 4rem', maxWidth: 880, margin: '0 auto' }}>
          ...
          {keys?.map((k) => (
            <div
              ...
              style={{
                ...
                alignItems: 'center', gap: '1rem', flexWrap: 'wrap', opacity: k.active ? 1 : 0.45,
              }}
            >
              <div style={{ minWidth: 0 }}>
                <p style={{ fontSize: '.82rem', fontWeight: 600, marginBottom: '.25rem' }}>{k.name}</p>
              ...
              {k.active && (
                <button
                  ...
                  style={{
                    ...
                    opacity: busyId === k.id ? 0.5 : 1, flexShrink: 0,
                  }}
                >
                  {busyId === k.id ? '...' : 'Cabut'}
                </button>
